...
Note: Code in this model requires tflite files with metadata encoded.

The code in here is derived from https://github.com/tensorflow/examples/tree/f38e125dcc9405a1be9e59609c99e72935e11cdf/lite/examples/object_detection/raspberry_pi under [Apache 2.0 Licence](https://github.com/tensorflow/examples/blob/master/LICENSE).

# Setup

Run `sh setup.sh`

# Webcam (Stream Examples)

## Using ssd mobilenet v1
Reasonably fast
```bash
python3 stream.py --model ssd_mobilenet_v1_1_metadata_1.tflite
```

## Using efficientdet_lite0
Very slow
...
```bash
python3 image.py --model ssd_mobilenet_v1_1_metadata_1.tflite  ~/projects/security-cam-reference-pictures/20210827-132503.jpg
```
